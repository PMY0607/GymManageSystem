...
;layui.define(["jquery", "element", "nprogress"], function (i) {
    var t = layui.jquery, e = layui.element, a = t(document), l = t(window), n = function () {
        this.config = {elem: void 0, mainUrl: "./view/main.html"}, this.v = "1.0.2"
    };
    ...
    var c = {
        ...
        createTabDom: function () {
            ...
            if (i._parentElem = e.elem, !i.tabDomExists()) {
                var a = ['<div class="layui-tab layui-tab-card kit-tab" lay-filter="' + i._filter + '">',
                    '<ul class="layui-tab-title">', '<li class="layui-this" lay-id="-1">' +
                    '<i class="layui-icon">&#xe68e;</i>收银台</li>', "</ul>",
                    ...
                    '<li class="kit-line"></li>', '<li class="kit-item" data-target="closeCurrent">关闭当前选项卡</li>',
                    '<li class="kit-item" data-target="closeOther">关闭其他选项卡</li>', '<li class="kit-line"></li>',
                    '<li class="kit-item" data-target="closeAll">关闭所有选项卡</li>', "</ul>", "</div>", '<div class="layui-tab-content">',
        ...
        tabAdd: function (i) {
            ...
            if (t.tabExists(s)) t.tabChange(s); else {
                ...
                var o = '<div class="layui-tab-item layui-show" lay-item-id="' + s + '"><iframe name="content_frame" src="' + c + '"></iframe></div>';
