...
<div class="container ">
                                ...
                                <ul class="dropdown-menu">
                                    <li style="display: inline">
                                        <div style="display: inline-flex; width: 20px">
                                            &nbsp;&nbsp;
                                            <a style="display: inline-flex; flex: 1"  href="/book/cancelBook?id=${info.id}" class="btn btn-danger">
                                                确定</a>
                                            &nbsp;&nbsp;&nbsp;
    ...
    <nav class="row">
        ...
        <div class="jump col-sm-8">
            ...
            <form id="myForm" action="/book/userBookInfo" enctype="multipart/form-data" method="post"></form>
        </div>
    </nav>
